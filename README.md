...
- **Biofluid validation.** In matched CSF and plasma (TMT-MS, SomaScan and Olink on the same 36 specimens, neat and top-14-depleted), MS quantifies
  16 to 23% of affinity targets in CSF and 5 to 10% in plasma. The trained score adds a stable +0.2 to +0.5 per SD beyond affinity abundance in every arm and predicts what depletion recovers; raw tryptic yield adds nothing
  to presence but predicts quantification fidelity in depleted plasma (r 0.33).
...
| 4 | `9.panel_audit.py`           | `organoids/somalogic/*medNormSMP*_organoids.adat` (aptamer annotation), `organoids/olink/olink_slim.csv` (assay annotation), `proteome_census.tsv`, `features_protein.tsv`, `features_peptides.tsv`, `ml_per_gene_predictions.tsv`, `paxdb_wholebody.tsv`, `organoid_gene_table.tsv`, `biofluid_gene_table.tsv` (optional, from 22), `interactions.tsv` | `panel_audit.tsv`, `panel_audit.txt`                                                                                            |
| 5 | `10.nominated_audit.py`      | `biomarkers.xlsx`, `panel_audit.tsv`, `proteome_census.tsv`, `features_peptides.tsv`, `features_protein.tsv`, `organoid_gene_table.tsv`, `interactions.tsv`                                                                                                                                                                                             | `nominated_audit.tsv`, `nominated_audit.txt`                                                                                    |
| 6 | `11.validation_routes.py`    | `uniprot_human.tsv`, `panel_audit.tsv`, `nominated_audit.tsv`                                                                                                                                                                                                                                                                                           | `validation_routes.tsv`, `validation_routes.txt`                                                                                |
